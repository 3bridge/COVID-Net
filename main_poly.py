...
def main():
    ...
    test_acc_file = 'polyruns/cont61/test' + str(args.cosine) + str(args.bna) + str(args.bnd) + '.txt'
    train_acc_file = 'polyruns/cont61/train' + str(args.cosine) + str(args.bna) + str(args.bnd) + '.txt'
...
def get_arguments():
    ...
    parser.add_argument('--save', type=str, default='polysaved/cont61',
