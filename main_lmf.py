...
def main():
    ...
    test_acc_file = 'lmfruns/cont6/test' + str(args.cosine) + str(args.bna) + str(args.bnd) + '.txt'
    train_acc_file = 'lmfruns/cont6/train' + str(args.cosine) + str(args.bna) + str(args.bnd) + '.txt'
...
def get_arguments():
    ...
    parser.add_argument('--save', type=str, default='lmfsaved/cont6',
