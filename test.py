...
model = CovidNet(bna=False, bnd=True, hidden_size=1024, emmbedding_size=128).to(device)

model.load_state_dict(
    torch.load('polysaved/cont6/best_checkpoint.pth', map_location=str(device))['state_dict'])
model.eval()
