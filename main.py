...
def main():
    ...
    test_acc_file = 'runs4/cont4/test' + str(args.cosine) + str(args.bna) + str(args.bnd) + '.txt'
    train_acc_file = 'runs4/cont4/train' + str(args.cosine) + str(args.bna) + str(args.bnd) + '.txt'
...
def get_arguments():
    ...
    parser.add_argument('--save', type=str, default='saved4/cont4',
